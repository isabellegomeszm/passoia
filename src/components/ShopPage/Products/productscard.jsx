...
function ProductCard({ product }) {
  ...
  const displayedImage =
    type === "variable" ? selectedColor?.image : image || defaultImage;

  const displayedPrice =
    variations && variations.length > 0 ? selectedColor?.price : price;
      ...
      <div className="product-content">
        ...
        {type === "variable" && (
          <div className="variations">
            <p className="variation-title">{selectedColor?.colorName}</p>
        ...
        <div className="buy">
          <p className="price">
            R${type === "variable"
              ? Number(selectedColor?.price || 0).toFixed(2)
